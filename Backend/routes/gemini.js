...
const GEMINI_API_KEY = process.env.GEMINI_API_KEY || 'AIzaSyCp7fSLhepFfLtnT35xjslZJEkGrOVLXSg'; // Fallback to provided key
...
async function fetchCityData(cityName) {
  try {
    ...
    const response = await axios.post('http://localhost:5000/api/city', {
      city: cityName
    }, {
      headers: {
